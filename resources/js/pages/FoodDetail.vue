        ...
        <div class="ticket-detail">
            ...
            <div class="container mt-4">
                ...
                <div class="mt-10 text-center">
                    ...
                    <p
                        class="d-flex align-items-center justify-content-center mb-6"
                    >
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-8">
                        ...
                        <div
                            class="card border-0 p-4 fs-4 shadow-sm rounded mb-4"
                        >
                            <p>✮ Hello Arte-Folks ✮</p>
                            <p>{{ product.description }}</p>
                            <p>
                                <strong>Date:</strong>
                                {{ formatDate(product.datetime) }}<br />
                        ...
                        <div class="mt-4">
                            ...
                            <div
                                class="card border-0 p-4 shadow-sm rounded mt-3 fs-4"
                            >
                                <h4>Tentang Tiket Festival</h4>
                                <ul>
                                    <li>
                                        Tiket Festival adalah kategori berdiri,
                                        dengan pengalaman menonton terbaik,
                                        dimana kamu bisa berdiri dekat sekali
                                        dengan panggung dan tentunya idola kamu.
                                    </li>
                                    <li>
                                        Untuk usia minimum penonton Festival 5
                                        Tahun
                                    </li>
                                    <li>
                                        Periode Presale 1 akan dimulai pada 8
                                        Juli 2024 dengan harga spesial
                                    </li>
                                    <li>
                                        Tiket yang sudah dibeli tidak dapat
                                        dikembalikan kecuali acara dibatalkan
                                        oleh penyelenggara (No Refund, No
                                        Upgrade / Downgrade)
                                    </li>
                                </ul>
                                <h4 class="mt-4">
                                    Tentang Tiket Festival EARLY ENTRY
                                </h4>
                                <p>Syarat & Ketentuan</p>
                                <ul>
                                    <li>
                                        Pemilik tiket Early Entry WAJIB sudah
                                        masuk venue maksimal pukul 16.30 WIB
                                    </li>
                                    <li>
                                        Apabila melebihi pukul 16.30 WIB, maka
                                        tiket akan hangus (dan harus membeli
                                        tiket lagi jika ingin tetap menonton
                                        konser)
                                    </li>
                                    <li>
                                        Penukaran tiket membawa ID Card Asli
                    ...
                    <div class="col-md-4">
                        ...
                        >
                            <h6>
                                Total ({{ this.pesan.jumlah_pemesanan }} pax):
                            </h6>
                            <p class="fs-5">
                                IDR
                                {{
        ...
        pemesanan() {
            ...
            const payload = {
                ...
                product: {
                    ...
                    total_harga:
                        this.pesan.jumlah_pemesanan * this.product.price,
                },
                user_id: userId,
        ...
        removeAccess() {
            ...
            if (userId) {
                axios
                    ...
                    .catch((error) => {
                        console.error(
                            "Terjadi kesalahan saat menghentikan akses:",
                            error
                        );
                    });
            } else {
